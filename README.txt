...
Pour consulter les images utilisées dans chaque mini-jeu, ouvrez les dossiers nommés d'après la nommenclature "img_" et le nom de l'auteur du jeu.
Pour consulter les musiques utilisées, ouvrez le dossier "son".
Retrouvez le code des menus, menu de sélection des mini-jeux ainsi que le programme des écrans de transition entre mini-jeux en ouvrant respectivement les fichiers "menu.py", "menu_mini_jeu.py" et "transition.py".
...
Les anneaux apparaissent à différents endroits de l'écran semi-aléatoirement. Passer dans un anneau rapporte 5 POINTS. Passer un certain cap de score, une zone rouge apparaîtra, entravant le mouvement du joueur et le forçant à être plus précis.
Obtenez 160 POINTS dans la limite de temps (30 secondes) pour gagner.
...
Notre code provient à 3.8483305061208916431468179165501898491994048047656561761574560614504571848471847187014987651374171898709170991493 % d'internet.
